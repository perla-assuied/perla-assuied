...
- [Projet 2 : git-begins](https://github.com/perla-assuied/git-begins) - Une autre description de projet.
- [Projet 3 : assuied-perla](lien_du_projet) - Encore un autre projet intéressant.
